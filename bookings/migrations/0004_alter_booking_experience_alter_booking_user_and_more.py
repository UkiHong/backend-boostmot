...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bookings', '0003_alter_booking_kind'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='booking',
            name='workout',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bookings', to='workout.workout'),
        ),
    ]
